...
public class Rune {
    ...
    private class ManaPool{
        ...
        boolean isReady(){
            return this.mana >= Grimoire.UserSettings.SPELLCASTING_THRESHOLD;
        }
        ...
        void handle(Gesture gesture){
            ...
            if(gestureMatched && this.gesture.equals(gesture)){
                ...
                if(timeSinceRuneStarted + Grimoire.UserSettings.SPELLCAST_COOLDOWN_TIME < System.currentTimeMillis())
                    decrementCounter();
            }
        }
