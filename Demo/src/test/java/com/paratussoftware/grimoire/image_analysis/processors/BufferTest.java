...
public class BufferTest {
    ...
    @Test
    public void testAddClusterCollection() {
    ...
    @Test
    public void testAddOverridesFirstClustersWhenCapacityIsReached() {
        String expected1 = "one";
        String expected2 = "two";
    ...
    @Test
    public void testAccessElementByIndex() {
    ...
    @Test
    public void testAccessElementsByIndex_afterCapacityReached() {
        Buffer<String> buffer = new Buffer<>(3);
        String value1 = "hello";
        String value2 = "world";
        String value3 = "foo";
    ...
    @Test
    public void testIteratorStartsAtFirstValueEachTimeCalled() {
        Buffer<String> buffer = new Buffer<>(3);
        String value1 = "hello";
        String value2 = "world";
        String value3 = "foo";
    ...
    @Test
    public void testBufferThrowsExceptionWhenBuiltWithCapacityOfZero() {
        try {
            new Buffer<String>(0);
