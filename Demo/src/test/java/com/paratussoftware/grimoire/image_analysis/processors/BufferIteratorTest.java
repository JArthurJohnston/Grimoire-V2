...
//        assertSame(expectedBuffer, fifoIterator.getBuffer());
    ...
    @Test
    public void testIteratorBeforeCapacityReached() {
    ...
    @Test
    public void testIteratorWhenCapacityReached() {
    ...
    @Test
    public void testIterator_afterCapacityReached() {
        Buffer<String> buffer = new Buffer<>(3);
        String value1 = "hello";
        String value2 = "world";
        String value3 = "foo";
    ...
    @Test
    public void testHasNextIsFalseWhenValuesIsEmpty() {
