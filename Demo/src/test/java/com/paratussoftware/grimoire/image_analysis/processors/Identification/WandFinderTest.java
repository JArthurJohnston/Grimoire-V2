...
public class WandFinderTest {
    ...
    @Test
    public void isPossibleWandPoint_size(){
    ...
    @Test
    public void testIsPossibleWandPoint_squarish() {
    ...
    @Test
    public void testNearestWandPointTo_empty() {
    ...
    @Test
    public void testNearestWandPointTo() {
        Grimoire.UserSettings.MAX_MOTION_SIZE_LIMIT = 5;
    ...
    @Test
    public void testFindPastWandPointsForCluster() {
